...
class Swift_Transport_Esmtp_Auth_NTLMAuthenticatorTest extends \SwiftMailerTestCase
{
    ...
    {
        if (!function_exists('mcrypt_module_open') || !function_exists(
    ...
    public function testLMv1Generator()
    {
        ...
        $login = $this->_getAuthenticator();
        $lmv1Result = $this->_invokePrivateMethod(
            'createLMPassword',
            $login,
    ...
    public function testLMv2Generator()
    {
        ...
        $login = $this->_getAuthenticator();
        $lmv2Result = $this->_invokePrivateMethod(
            'createLMv2Password',
            $login,
    ...
    public function testMessage3v1Generator()
    {
        ...
        $login = $this->_getAuthenticator();
        $message3 = $this->_invokePrivateMethod(
            'createMessage3',
            $login,
    ...
    public function testSuccessfulAuthentication()
    {
        ...
        $this->assertTrue(
            $ntlm->authenticate(
                ...
                $username . '@' . $domain,
                $secret,
                $this->hex2bin("30fa7e3c677bc301"),
                $this->hex2bin("f5ce3d2401c8f6e9")
            ),
