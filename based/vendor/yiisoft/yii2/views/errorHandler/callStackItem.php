...
?>
<li class="<?php if (!$handler->isCoreFile($file) || $index === 1) {
    echo 'application';
} ?> call-stack-item"
            ...
            <?php if ($method !== null): ?>
                <span class="call">
                    ...
                    <?= ($class !== null ? $handler->addTypeLinks("$class::$method") : $handler->htmlEncode(
                        $method
                    )) . '(' . $handler->argumentsToString($args) . ')' ?>
                </span>
            <?php endif; ?>
            <span class="at"><?php if ($line !== null) {
                    echo 'at line';
                } ?></span>
    ...
    <?php if (!empty($lines)): ?>
        <div class="code-wrap">
            ...
            <div class="code">
                <?php for ($i = $begin;
                $i <= $end;
                ++$i): ?><span class="lines-item"><?= (int)($i + 1) ?></span><?php endfor; ?>
                <pre><?php
