...
class HTMLPurifier_TagTransformTest extends HTMLPurifier_Harness
{
    ...
    public function testSimpleWithCSS()
    {
        ...
        $this->assertTransformation(
            $transformer,
            'center',
            array('class' => 'boom', 'style' => 'font-weight:bold;'),
            'div',
            array('class' => 'boom', 'style' => 'text-align:center;font-weight:bold;'),
        ...
        $this->assertTransformation(
            ...
            'div',
            array('style' => 'text-align:center;font-weight:bold;'),
            array('style' => 'text-align:center;')
        );
    ...
    public function testFont()
    {
        ...
        $this->assertTransformation(
            $transformer,
            'font',
            array('color' => 'red', 'face' => 'Arial', 'size' => '6'),
            'span',
            array('style' => 'color:red;font-family:Arial;font-size:xx-large;')
        );
    }
}
