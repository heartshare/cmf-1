...
?>
    ...
    <head>
        ...
        <style type="text/css">
            ...
            .HTMLPurifier_Printer td, .HTMLPurifier_Printer th {
                padding: 3px;
                border: 1px solid #000;
                background: #CCC;
            ...
            .HTMLPurifier_Printer caption {
                font-size: 1.5em;
                font-weight: bold;
            }

            .HTMLPurifier_Printer .heavy {
                background: #99C;
                text-align: center;
            }

            .HTMLPurifier_Printer .unsafe {
                background: #C99;
            }
    ...
    <dl>
        ...
        <dd>Whether or not HTML Purifier's output is Transitional or
            ...
            and converts many deprecated elements.
        </dd>
        <dt>#PCDATA</dt>
        ...
        <dd>A tag transform will change one tag to another. Example: <code>font</code>
            turns into a <code>span</code> tag with appropriate CSS.
        </dd>
        ...
        <dd>Tags that an element excludes are excluded for all descendants of
            that element, and not just the children of them.
        </dd>
        <dt>Name(Param1, Param2)</dt>
        <dd>Represents an internal data-structure. You'll have to check out
            the corresponding classes in HTML Purifier to find out more.
        </dd>
    </dl>
