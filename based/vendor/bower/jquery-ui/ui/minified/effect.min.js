...
(function (t) {
    ...
    return t.effects = {effect: {}}, function (t, e) {
        ...
        function s(i) {
            var s = l(), n = s._rgba = [];
            return i = i.toLowerCase(), d(h, function (t, o) {
                var r, a = o.re.exec(i), h = a && o.parse(a), l = o.space || "rgba";
        ...
        var o, r = "backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor", a = /^([\-+])=\s*(\d+\.?\d*)/, h = [
        ...
        }, c = {rgba: {props: {red: {idx: 0, type: "byte"}, green: {idx: 1, type: "byte"}, blue: {idx: 2, type: "byte"}}}, hsla: {props: {hue: {idx: 0, type: "degrees"}, saturation: {idx: 1, type: "percent"}, lightness: {idx: 2, type: "percent"}}}}, p = {"byte": {floor: !0, max: 255}, percent: {max: 1}, degrees: {mod: 360, floor: !0}}, u = l.support = {}, f = t("<p>")[0], d = t.each;
        f.style.cssText = "background-color:rgba(1,1,1,.5)", u.rgba = f.style.backgroundColor.indexOf("rgba") > -1, d(c, function (t, e) {
            e.cache = "_" + t, e.props.alpha = {idx: 3, type: "percent", def: 1}
        }), l.fn = t.extend(l.prototype, {parse: function (n, r, a, h) {
            if (n === e)return this._rgba = [null, null, null, null], this;
            (n.jquery || n.nodeType) && (n = t(n).css(r), r = e);
            var p = this, u = t.type(n), f = this._rgba = [];
            return r !== e && (n = [n, r, a, h], u = "array"), "string" === u ? this.parse(s(n) || o._default) : "array" === u ? (d(c.rgba.props, function (t, e) {
                f[e.idx] = i(n[e.idx], e)
            }), this) : "object" === u ? (n instanceof l ? d(c, function (t, e) {
            ...
            return d(c, function (t, o) {
                var r, a = i[o.cache];
                return a && (r = n[o.cache] || o.to && o.to(n._rgba) || [], d(o.props, function (t, i) {
                    return null != a[i.idx] ? s = a[i.idx] === r[i.idx] : e
                })), s
            }), s
        }, _space: function () {
            var t = [], e = this;
            return d(c, function (i, s) {
                e[s.cache] && t.push(i)
            }), t.pop()
        }, transition: function (t, e) {
            var s = l(t), n = s._space(), o = c[n], r = 0 === this.alpha() ? l("transparent") : this, a = r[o.cache] || o.to(r._rgba), h = a.slice();
            return s = s[o.cache], d(o.props, function (t, n) {
                var o = n.idx, r = a[o], l = s[o], c = p[n.type] || {};
                null !== l && (null === r ? h[o] = l : (c.mod && (l - r > c.mod / 2 ? r += c.mod : r - l > c.mod / 2 && (r -= c.mod)), h[o] = i((l - r) * e + r, n)))
            }), this[n](h)
        }, blend: function (e) {
            ...
            var e, i, s = t[0] / 255, n = t[1] / 255, o = t[2] / 255, r = t[3], a = Math.max(s, n, o), h = Math.min(s, n, o), l = a - h, c = a + h, p = .5 * c;
            ...
            l.fn[s] = function (s) {
                ...
                var n, a = t.type(s), p = "array" === a || "object" === a ? s : arguments, u = this[r].slice();
                ...
                l.fn[e] || (l.fn[e] = function (n) {
                    var o, r = t.type(n), h = "alpha" === e ? this._hsla ? "hsla" : "rgba" : s, l = this[h](), c = l[i.idx];
                    return"undefined" === r ? c : ("function" === r && (n = n.call(this, c), r = t.type(n)), null == n && i.empty ? this : ("string" === r && (o = a.exec(n), o && (n = c + parseFloat(o[2]) * ("+" === o[1] ? 1 : -1))), l[i.idx] = n, this[h](l)))
                })
            })
        }), l.hook = function (e) {
            var i = e.split(" ");
        ...
        }, l.hook(r), t.cssHooks.borderColor = {expand: function (t) {
            var e = {};
        ...
        t.each(["borderLeftStyle", "borderRightStyle", "borderBottomStyle", "borderTopStyle"], function (e, s) {
            ...
            return this.queue(function () {
                var o, r = t(this), a = r.attr("class") || "", l = h.children ? r.find("*").addBack() : r;
                l = l.map(function () {
                    var i = t(this);
        ...
        t.extend(t.effects, {version: "1.11.1", save: function (t, i) {
            ...
            var s = i.apply(this, arguments), n = s.mode, o = s.queue, r = t.effects.effect[s.effect];
