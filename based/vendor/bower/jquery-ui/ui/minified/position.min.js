...
(function (t) {
    ...
    return function () {
        ...
        t.position = {scrollbarWidth: function () {
            ...
            n = t.extend({}, n);
            var p, g, m, v, _, b, y = t(n.of), w = t.position.getWithinInfo(n.within), k = t.position.getScrollInfo(w), x = (n.collision || "flip").split(" "), D = {};
            ...
            }), 1 === x.length && (x[1] = x[0]), "right" === n.at[0] ? _.left += g : "center" === n.at[0] && (_.left += g / 2), "bottom" === n.at[1] ? _.top += m : "center" === n.at[1] && (_.top += m / 2), p = e(D.at, g, m), _.left += p[0], _.top += p[1], this.each(function () {
                var s, l, c = t(this), u = c.outerWidth(), d = c.outerHeight(), f = i(this, "marginLeft"), b = i(this, "marginTop"), C = u + f + i(this, "marginRight") + k.width, I = d + b + i(this, "marginBottom") + k.height, P = t.extend({}, _), M = e(D.my, c.outerWidth(), c.outerHeight());
                "right" === n.my[0] ? P.left -= u : "center" === n.my[0] && (P.left -= u / 2), "bottom" === n.my[1] ? P.top -= d : "center" === n.my[1] && (P.top -= d / 2), P.left += M[0], P.top += M[1], o || (P.left = h(P.left), P.top = h(P.top)), s = {marginLeft: f, marginTop: b}, t.each(["left", "top"], function (e, i) {
                    t.ui.position[x[e]] && t.ui.position[x[e]][i](P, {targetWidth: g, targetHeight: m, elemWidth: u, elemHeight: d, collisionPosition: s, collisionWidth: C, collisionHeight: I, offset: [p[0] + M[0], p[1] + M[1]], my: n.my, at: n.at, within: w, elem: c})
                }), n.using && (l = function (t) {
                    var e = v.left - P.left, i = e + g - u, s = v.top - P.top, o = s + m - d, h = {target: {element: y, left: v.left, top: v.top, width: g, height: m}, element: {element: c, left: P.left, top: P.top, width: u, height: d}, horizontal: 0 > i ? "left" : e > 0 ? "right" : "center", vertical: 0 > o ? "top" : s > 0 ? "bottom" : "middle"};
