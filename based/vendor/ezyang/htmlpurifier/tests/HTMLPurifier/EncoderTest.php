...
class HTMLPurifier_EncoderTest extends HTMLPurifier_Harness
{
    ...
    public function testIconvTruncateBug()
    {
        ...
        $this->assertIdentical(
            HTMLPurifier_Encoder::convertFromUTF8(
                "\xE4\xB8\xAD" . str_repeat('a', 10000),
                $this->config,
                $this->context
            ),
            str_repeat('a', 10000)
    ...
    public function testIconvChunking()
    {
        ...
        $this->assertIdentical(
            HTMLPurifier_Encoder::iconv('utf-8', 'iso-8859-1//IGNORE', "a\xF3\xA0\x80\xA0b", 4),
            'ab'
        );
        ...
        $this->assertIdentical(
            HTMLPurifier_Encoder::iconv('utf-8', 'iso-8859-1//IGNORE', "aaaa\xF3\xA0\x80\xA0b", 4),
            'aaaab'
        );
        $this->assertIdentical(
            HTMLPurifier_Encoder::iconv('utf-8', 'iso-8859-1//IGNORE', "aaaa\xE4\xB8\xADb", 4),
            'aaaab'
        );
