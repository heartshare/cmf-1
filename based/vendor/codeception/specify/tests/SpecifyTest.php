...
class SpecifyTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSpecification()
    {
        ...
        $this->specify(
            'i can fail here but test goes on',
            function () {
    ...
    {
        $this->specify(
            'i bubble exception up if no throws is defined',
            function () {
                throw new RuntimeException;
            }
        );
