...
!function (a) {
    ...
    function e(b, c) {
        function d(a) {
            ...
            function d(a, c, d) {
                ...
                } else a.matches.splice(d++, 0, {fn: null, cardinality: 0, optionality: a.isOptional, newBlockMarker: f, casing: null, def: c, placeholder: void 0, mask: c}), l = !1
            }
        ...
        var f = void 0;
        if (a.isFunction(b.mask) && (b.mask = b.mask.call(this, b)), a.isArray(b.mask))if (c)f = [], a.each(b.mask, function (b, c) {
    ...
    function f(b, d, e) {
        ...
        function q(b, c, d) {
            if (e.insertMode && void 0 != h().validPositions[b] && void 0 == d) {
                ...
                for (f = b; i >= f; f++) {
                    var l = g[f];
                    if (void 0 != l) {
                        var m = h().validPositions;
                        j = !e.keepStatic && (void 0 != m[f + 1] && v(f + 1, m[f].locator.slice(), f).length > 1 || m[f] && void 0 != m[f].alternation) ? f + 1 : D(f), k = u(j, l.match.def) ? k && A(j, l.input, !0, !0) !== !1 : null == l.match.fn
                    }
                    if (!k)break
                }
                if (!k)return h().validPositions = a.extend(!0, {}, g), !1
        ...
        function v(b, c, d) {
            function f(c, d, g, j) {
                function m(g, j, o) {
                    if (i > 1e4)return alert("jquery.inputmask: There is probably an error in your mask definition or in the code. Create an issue on github with an example of the mask you are using. " + h().mask), !0;
                    if (i == b && void 0 == g.matches)return k.push({match: g, locator: j.reverse()}), !0;
                    if (void 0 != g.matches) {
                        if (g.isGroup && o !== !0) {
            ...
            if (void 0 == c) {
                ...
                if (void 0 != m && n > -1)i = n, j = m.locator.slice(); else {
        ...
        function y(a, b) {
            var c = x().slice();
            if (a === !0)o(), a = 0, b = c.length; else for (var d = a; b > d; d++)delete h().validPositions[d], delete h().tests[d];
        ...
        function A(b, c, d, f) {
            function g(b, c, d, f) {
                ...
                return a.each(v(b), function (i, j) {
                    for (var k = j.match, l = c ? 1 : 0, m = "", n = (x(), k.cardinality); n > l; n--)m += F(b - (n - 1));
                    if (c && (m += c), g = null != k.fn ? k.fn.test(m, h(), b, d, e) : c != k.def && c != e.skipOptionalPartCharacter || "" == k.def ? !1 : {c: k.def, pos: b}, g !== !1) {
                        ...
                        if (void 0 != g.remove && r(g.remove, g.remove + 1), g.refreshFromBuffer) {
                            ...
                            if (d = !0, y(u === !0 ? u : u.start, u.end), void 0 == g.pos && void 0 == g.c)return g.pos = p(), !1;
                            if (t = void 0 != g.pos ? g.pos : b, t != b)return g = a.extend(g, A(t, s, !0)), !1
                        } else if (g !== !0 && void 0 != g.pos && g.pos != b && (t = g.pos, y(b, t), t != b))return g = a.extend(g, A(t, s, !0)), !1;
            ...
            function i(b, c, d, f) {
                ...
                if (void 0 != i)for (var k in h().validPositions)if (parseInt(k) > parseInt(g) && void 0 === h().validPositions[k].alternation) {
                    for (var l = h().validPositions[k], m = l.locator[i], n = h().validPositions[g].locator[i].split(","), q = 0; q < n.length; q++)if (m < n[q]) {
                        ...
                        if (m != r.locator[i]) {
                            for (var u = x().slice(), v = k; v < p() + 1; v++)delete h().validPositions[v], delete h().tests[v];
            ...
            var l = b, m = !1;
            if (f && l >= C() && o(!0), l < C() && (m = g(l, c, d, f), !d && m === !1)) {
                var n = h().validPositions[l];
                if (!n || null != n.match.fn || n.match.def != c && c != e.skipOptionalPartCharacter) {
                    if ((e.insertMode || void 0 == h().validPositions[D(l)]) && !B(l))for (var s = l + 1, t = D(l); t >= s; s++)if (m = g(s, c, d, f), m !== !1) {
                        l = s;
                        break
                    }
                } else m = {caret: D(l)}
            }
            return m === !1 && e.keepStatic && Q(j) && (m = i(b, c, d, f)), m === !0 && (m = {pos: l}), m
        }
        ...
        function C() {
            ...
            if (eb = db.prop("maxLength"), -1 == eb && (eb = void 0), 0 == e.greedy) {
                ...
                for (b = c + 1; void 0 == d || null != d.match.fn || null == d.match.fn && "" != d.match.def; b++)d = s(b, f, b - 1), f = d.locator.slice();
                a = b
            } else a = x().length;
        ...
        function H(b, c) {
            c = c || t(b);
            var d = a.isFunction(c.placeholder) ? c.placeholder.call(this, e) : c.placeholder;
            return void 0 != d ? d : null == c.fn ? c.def : e.placeholder.charAt(b % e.placeholder.length)
        }
        ...
        function I(b, c, d, f, g) {
            ...
            if (o(), c && b._valueSet(""), a.each(i, function (c, e) {
                ...
                } else X.call(b, void 0, !0, e.charCodeAt(0), !1, d, d ? c : h().p), d = d || c > 0 && c > h().p
            }), c) {
        ...
        function L(b) {
            if (b.data("_inputmask") && !b.hasClass("hasDatepicker")) {
                ...
                return a.isFunction(e.onUnMask) && (g = e.onUnMask.call(b, i, g, e) || g), g
            }
        ...
        function O(b) {
            ...
            for (c = g + 1; c < e.length; c++)d = s(c, k, c - 1), k = d.locator.slice(), i[c] = a.extend(!0, {}, d);
        ...
        function T(b) {
            ...
            function e(b) {
                ...
                c ? (h.call(this, a.isFunction(c.opts.onBeforeMask) ? c.opts.onBeforeMask.call(nb, b, c.opts) || b : b), a(this).triggerHandler("setvalue.inputmask")) : h.call(this, b)
            }
        ...
        function U(b, c, d) {
            function f() {
                if (e.keepStatic) {
                    o(!0);
                    var a, c = [];
                    for (a = p(); a >= 0; a--)if (h().validPositions[a]) {
                        if (void 0 != h().validPositions[a].alternation)break;
                        c.push(h().validPositions[a].input), delete h().validPositions[a]
                    }
                    if (a > 0)for (; c.length > 0;)h().p = D(p()), X.call(b, void 0, !0, c.pop().charCodeAt(0), !1, !1, h().p)
                }
            }

            if ((e.numericInput || fb) && (c == a.inputmask.keyCode.BACKSPACE ? c = a.inputmask.keyCode.DELETE : c == a.inputmask.keyCode.DELETE && (c = a.inputmask.keyCode.BACKSPACE), fb)) {
                var g = d.end;
                d.end = d.begin, d.begin = g
            }
            c == a.inputmask.keyCode.BACKSPACE && d.end - d.begin <= 1 ? d.begin = E(d.begin) : c == a.inputmask.keyCode.DELETE && d.begin == d.end && d.end++, r(d.begin, d.end), f();
            var i = p(d.begin);
            i < d.begin ? (-1 == i && o(), h().p = D(i)) : h().p = d.begin
        }
        ...
        function W(b) {
            ...
            f == a.inputmask.keyCode.BACKSPACE || f == a.inputmask.keyCode.DELETE || i && 127 == f || b.ctrlKey && 88 == f ? (b.preventDefault(), 88 == f && (cb = x().join("")), U(c, f, g), G(c, x(), h().p), c._valueGet() == w().join("") && d.trigger("cleared"), e.showTooltip && d.prop("title", h().mask)) : f == a.inputmask.keyCode.END || f == a.inputmask.keyCode.PAGE_DOWN ? setTimeout(function () {
                var a = D(p());
                e.insertMode || a != C() || b.shiftKey || a--, N(c, b.shiftKey ? g.begin : a, a)
            }, 0) : f == a.inputmask.keyCode.HOME && !b.shiftKey || f == a.inputmask.keyCode.PAGE_UP ? N(c, 0, b.shiftKey ? g.begin : 0) : f == a.inputmask.keyCode.ESCAPE || 90 == f && b.ctrlKey ? (I(c, !0, !1, cb.split("")), d.click()) : f != a.inputmask.keyCode.INSERT || b.shiftKey || b.ctrlKey ? 0 != e.insertMode || b.shiftKey || (f == a.inputmask.keyCode.RIGHT ? setTimeout(function () {
                var a = N(c);
                N(c, a.begin)
            }, 0) : f == a.inputmask.keyCode.LEFT && setTimeout(function () {
                var a = N(c);
        ...
        function X(b, c, d, f, g, i) {
            ...
            if (d) {
                ...
                p && (h().undoPositions = a.extend(!0, {}, h().validPositions), U(j, a.inputmask.keyCode.DELETE, m), e.insertMode || (e.insertMode = !e.insertMode, q(m.begin, g), e.insertMode = !e.insertMode), p = !e.multi), h().writeOutBuffer = !0;
                var r = fb && !p ? m.end : m.begin, s = A(r, n, g);
                if (s !== !1) {
                    if (s !== !0 && (r = void 0 != s.pos ? s.pos : r, n = void 0 != s.c ? s.c : n), o(!0), void 0 != s.caret)l = s.caret; else {
        ...
        function Y(b) {
            ...
            V(d, i, h), f == a.inputmask.keyCode.TAB && e.showMaskOnFocus && (c.hasClass("focus-inputmask") && 0 == d._valueGet().length ? (o(), g = x(), G(d, g), N(d, 0), cb = x().join("")) : (G(d, g), N(d, M(0), M(C()))))
        }

        function Z(b) {
            if (hb === !0 && "input" == b.type)return hb = !1, !0;
            ...
            var g = a.isFunction(e.onBeforePaste) ? e.onBeforePaste.call(c, f, e) || f : f;
            return I(c, !0, !1, fb ? g.split("").reverse() : g.split(""), !0), d.click(), Q(x()) === !0 && d.trigger("complete"), !1
        }

        function $(b) {
            if (hb === !0 && "input" == b.type)return hb = !1, !0;
            var c = this, d = N(c), e = c._valueGet();
            e = e.replace(new RegExp("(" + J(w().join("")) + ")*"), ""), d.begin > e.length && (N(c, e.length), d = N(c)), x().length - e.length != 1 || e.charAt(d.begin) == x()[d.begin] || e.charAt(d.begin + 1) == x()[d.begin] || B(d.begin) || (b.keyCode = a.inputmask.keyCode.BACKSPACE, W.call(c, b)), b.preventDefault()
        }
            ...
            if (db = a(b), db.is(":input") && c(db.attr("type"))) {
                ...
                db.unbind(".inputmask"), db.removeClass("focus-inputmask"), db.closest("form").bind("submit",function () {
                    ...
                    a(b).is(":focus") && setTimeout(function () {
                        var c = N(b);
                        if (c.begin == c.end)if (e.radixFocus && "" != e.radixPoint && -1 != a.inArray(e.radixPoint, x()) && x().join("") == w().join(""))N(b, a.inArray(e.radixPoint, x())); else {
                            var d = fb ? M(c.begin) : c.begin, f = D(p(d));
                            f > d ? N(b, B(d) ? d : D(d)) : N(b, f)
                        }
                    }, 0)
                ...
                var i = a.isFunction(e.onBeforeMask) ? e.onBeforeMask.call(b, b._valueGet(), e) || b._valueGet() : b._valueGet();
        ...
        if (void 0 != b)switch (b.action) {
            ...
            case"format":
                ...
                var jb = (a.isFunction(e.onBeforeMask) ? e.onBeforeMask.call(db, b.value, e) || b.value : b.value).split("");
    ...
    return a.extend(a.inputmask.defaults.definitions, {h: {validator: "[01][0-9]|2[0-3]", cardinality: 2, prevalidator: [
    ...
    ]}}), a.extend(a.inputmask.defaults.aliases, {"dd/mm/yyyy": {mask: "1/2/y", placeholder: "dd/mm/yyyy", regex: {val1pre: new RegExp("[0-3]"), val1: new RegExp("0[1-9]|[12][0-9]|3[01]"), val2pre: function (b) {
    ...
    ]}, 2: {validator: function (a, b, c, d, e) {
    ...
    ]}, y: {validator: function (a, b, c, d, e) {
    ...
    ]}}, insertMode: !1, autoUnmask: !1}, "mm/dd/yyyy": {placeholder: "mm/dd/yyyy", alias: "dd/mm/yyyy", regex: {val2pre: function (b) {
        var c = a.inputmask.escapeRegex.call(this, b);
    ...
    }, val1pre: new RegExp("[01]"), val1: new RegExp("0[1-9]|1[012]")}, leapday: "02/29/", onKeyUp: function (b) {
        var c = a(this);
        if (b.ctrlKey && b.keyCode == a.inputmask.keyCode.RIGHT) {
            var d = new Date;
            c.val((d.getMonth() + 1).toString() + d.getDate().toString() + d.getFullYear().toString())
        }
    }}, "yyyy/mm/dd": {mask: "y/1/2", placeholder: "yyyy/mm/dd", alias: "mm/dd/yyyy", leapday: "/02/29", onKeyUp: function (b) {
        var c = a(this);
        if (b.ctrlKey && b.keyCode == a.inputmask.keyCode.RIGHT) {
            var d = new Date;
    ...
    ]}, t: {validator: function (a, b, c, d, e) {
    ...
    }, cardinality: 1}}}, email: {mask: "*{1,64}[.*{1,64}][.*{1,64}][.*{1,64}]@*{1,64}[.*{2,64}][.*{2,6}][.*{1,2}]", greedy: !1, onBeforePaste: function (a) {
    ...
    return a.extend(a.inputmask.defaults.aliases, {numeric: {mask: function (a) {
    ...
    }, placeholder: "", greedy: !1, digits: "*", digitsOptional: !0, groupSeparator: "", radixPoint: ".", radixFocus: !0, groupSize: 3, autoGroup: !1, allowPlus: !0, allowMinus: !0, integerDigits: "+", prefix: "", suffix: "", rightAlign: !0, decimalProtect: !0, postFormat: function (b, c, d, e) {
        var f = !1, g = b[c];
        ...
        if (!d && (e.allowMinus && "-" === a || e.allowPlus && "+" === a)) {
            ...
            if (f && f.length > 0 && "0" !== f[f.index])return b[f.index] == ("-" === a ? "+" : "-") ? {pos: f.index, c: a, remove: f.index, caret: c} : b[f.index] == ("-" === a ? "-" : "+") ? {remove: f.index, caret: c - 1} : {pos: f.index, c: a, caret: c + 1}
        }
        return!1
        ...
        if (g && !e && (-1 == h || g.index < h))if (0 == g[0].indexOf("0") && d >= f.prefix.length) {
            if (-1 == h || h >= d && void 0 == c.validPositions[h])return c.buffer.splice(g.index, 1), d = d > g.index ? d - 1 : g.index, {pos: d, remove: g.index};
            if (d > g.index && h >= d)return c.buffer.splice(g.index, 1), d = d > g.index ? d - 1 : g.index, {pos: d, remove: g.index}
        ...
        if (!f) {
            var g = "[";
            e.allowMinus === !0 && (g += "-"), e.allowPlus === !0 && (g += "+"), g += "]", f = new RegExp(g).test(a)
        }
        return f
    }, cardinality: 1, prevalidator: null, placeholder: ""}, ":": {validator: function (b, c, d, e, f) {
        var g = f.signHandler(b, c.buffer, d, e, f);
        if (!g) {
