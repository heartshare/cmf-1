...
class HTMLPurifier_Strategy_MakeWellFormed_ErrorsTest extends HTMLPurifier_Strategy_ErrorsHarness
{
    ...
    {
        $this->expectErrorCollection(
            E_NOTICE,
            'Strategy_MakeWellFormed: Tag auto closed',
            new HTMLPurifier_Token_Start('p', array(), 1, 0)
        );
    ...
    public function testTagClosedByElementEnd()
    {
        $this->expectErrorCollection(
            ...
            new HTMLPurifier_Token_Start('b', array(), 1, 3)
        );
    ...
    public function testTagClosedByDocumentEnd()
    {
        $this->expectErrorCollection(
            ...
            new HTMLPurifier_Token_Start('b', array(), 1, 0)
        );
