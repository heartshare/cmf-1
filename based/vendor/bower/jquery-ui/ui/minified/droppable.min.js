...
(function (t) {
    ...
    return t.widget("ui.droppable", {version: "1.11.1", widgetEventPrefix: "drop", options: {accept: "*", activeClass: !1, addClasses: !0, greedy: !1, hoverClass: !1, scope: "default", tolerance: "intersect", activate: null, deactivate: null, drop: null, out: null, over: null}, _create: function () {
        ...
        return function (e, i, s, n) {
            ...
            var o = (e.positionAbs || e.position.absolute).left, r = (e.positionAbs || e.position.absolute).top, a = o + e.helperProportions.width, l = r + e.helperProportions.height, h = i.offset.left, c = i.offset.top, p = h + i.proportions().width, u = c + i.proportions().height;
            switch (s) {
                case"fit":
                    return o >= h && p >= a && r >= c && u >= l;
                case"intersect":
                    return o + e.helperProportions.width / 2 > h && p > a - e.helperProportions.width / 2 && r + e.helperProportions.height / 2 > c && u > l - e.helperProportions.height / 2;
                case"pointer":
                    return t(n.pageY, c, i.proportions().height) && t(n.pageX, h, i.proportions().width);
                case"touch":
                    return(r >= c && u >= r || l >= c && u >= l || c > r && l > u) && (o >= h && p >= o || a >= h && p >= a || h > o && a > p);
                default:
                    return!1
            }
        }
